...
with open('bell-times.csv') as csv_file:
    ...
    for row in csv_reader:
        if line_count > 0:
            ...
            <a class="weatherwidget-io" href="https://forecast7.com/en/53d54n113d30/sherwood-park/" data-label_1="Sherwood Park" data-label_2="Weather" data-days="3" data-theme="pure" >Sherwood Park Weather</a>
            <script>
